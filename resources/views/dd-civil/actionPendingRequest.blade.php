                ...
                <div class="accordion-item">
                    ...
                    <div id="collapsePersonal" class="accordion-collapse collapse show"
                        ...
                        <div class="accordion-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <label class="info-label">AD Status</label>
                                    <div class="info-value">
                                        @if($request->ad_status == 1)
                                            <span class="badge badge-resolved">Approved</span>
                                        @elseif($request->ad_status == 0)
                                            <span class="badge badge-rejected">Disapproved</span>
                                        @else
                                            <span class="badge badge-pending">Pending</span>
                                        @endif
                                ...
                                <div class="col-md-4">
                                    <label class="info-label">AD Remarks</label>
                                    <div class="info-value">{{ $request->ad_remarks }}</div>
                                </div>
                                <div class="col-md-4" style="position:relative;">
                                    <label class="info-label">AD Response Date</label>
                                    <div class="info-value">{{ $request->ad_date }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
...
@else
    @if(!$hasExistingObjections)
    <form action="/dd-civil/submit-pending-request/{{ $request->id }}" method="POST" class="mt-3">
    @csrf
    ...
    <div id="statusSection" class="form-row px-4"
        ...
        <div class="col-md-3">
            ...
            <select name="verify_status" id="verify_status" class="form-control">
                ...
                <option {{ $request->dd_status == '1' ? 'selected' : '' }} value="1">Approved</option>
                <option {{ $request->dd_status == '0' ? 'selected' : '' }} value="0">Disapproved</option>
            </select>
        </div>
        <div class="col-md-6">
