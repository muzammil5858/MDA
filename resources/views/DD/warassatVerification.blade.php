  ...
  flex: 0 0 25%;
            ...
            <div class="col-11 col-sm-10 col-md-10 text-center p-0 mt-3 mb-2">
                <div class="card px-4 pt-4 pb-0 mt-3 mb-3">
                    ...
                    @if ($errors->any())
                        ...
                        @endif
                    <form id="msform" action="{{route('DDverification',$request->request_type)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- Progressbar -->
                        <ul id="progressbar">
                            <li class="active" id="account"><strong>Property Details</strong></li>
                            <li id="payment"><strong>Attachments</strong></li>
                            <li id="payment" ><strong>Requester Statements</strong></li>
                            <li id="payment"><strong>Witnesses Statement</strong></li>
                        </ul>
                        <div class="progress">
                            ...
                            <div class="form-card">
                                <div class="row">
                                    <div class="col-7 d-flex">
                                        ...
                                        <button type="button" class="btn btn-primary ml-3" data-bs-toggle="modal" data-bs-target="#allOwnersModal">
    View Owner
</button>
                                    </div>
                                </div>
                                ...
                                <!-- Input 1 -->
                                <div class="modal fade ml-5 mt-5" id="allOwnersModal" tabindex="-1" aria-labelledby="allOwnersModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
                ...
                <div class="card shadow-sm mb-4" style="background-color: #eeeeee; border: none; border-radius: 10px;">
                                <div class="card-body">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control"  name="owner[{{$key}}][name]" readonly
                                            placeholder="Enter Seller Name" value="{{$value->name}}">
                                    </div>
                                    <div class="col-md-4">
                                        <label>Owner's Father Name</label>
                                        <input type="text" class="form-control"  name="owner[{{$key}}][father_name]" readonly
                                            placeholder="Enter Seller's Father Name" value="{{$value->father_name}}">
                                    </div>
                                    <div class="col-md-4">
                                        <label>Owner's CNIC</label>
                                        <input type="text" class="form-control" id="owner_cnic_{{$key}}" name="owner[{{$key}}][cnic]" readonly
                                            placeholder="Enter Seller's CNIC" value="{{$value->cnic}}">
                                    </div>
                                    <div class="col-md-4">
                                        <label>Owner's Address</label>
                                        <input type="text" class="form-control" name="owner[{{$key}}][address]" 
                                            placeholder="Enter Seller's Address" value="{{$value->address}}" onchange="change(this);">
                                    </div>
                                    <div class="col-md-4">
                                        <label>Owner's Area</label>
                                        <input type="text" class="form-control" name="owner[{{$key}}][area]" 
                                            placeholder="Enter Seller's Area" value="{{$value->area}} Marla" onchange="change(this);">
                                    </div>
                                    </div>
                                     <input type="hidden" name="owner[{{$key}}][cnic_front]" value="{{$value->cnic_front}}">
                                     <input type="hidden" name="owner[{{$key}}][cnic_back]" value="{{$value->cnic_back}}">
                                     <input type="hidden" name="owner[{{$key}}][id]" value="{{$value->id}}">
                                    @endforeach
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                            ...
                            <input type="hidden" name="shared_attorney_check" value="{{!is_null($data->shared_attorney) ? 1 : 0}}">
                            <div class="row">
                                    <div class="col-7">
                            ...
                            <div class="card shadow-sm mb-4 " style="background-color: #eeeeee; border: none; border-radius: 10px;">
                                <div class="card-body">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control address"  name="attorney[{{$key}}][name]" readonly
                                            placeholder="Enter Seller Name" value="{{$value->owner->name}}">
                                    </div>
                                    <div class="col-md-4">
                                        <label>Requester's Father Name</label>
                                        <input type="text" class="form-control address"  name="attorney[{{$key}}][father_name]" readonly
                                            placeholder="Enter Seller's Father Name" value="{{$value->owner->father_name}}">
                                    </div>
                                    <div class="col-md-4">
                                        <label>Requester's CNIC</label>
                                        <input type="text" class="form-control" id="requester_cnic_{{$key}}" name="attorney[{{$key}}][cnic]" readonly
                                            placeholder="Enter Seller's CNIC" value="{{$value->owner->cnic}}">
                                    </div>
                                    <div class="col-md-4">
                                        <label>Requester's Address</label>
                                        <input type="text" class="form-control address" name="attorney[{{$key}}][address]" 
                                            placeholder="Enter Seller's Address" value="{{$value->owner->address}}" onchange="change(this);">
                                    </div>
                                    <div class="col-md-4">
                                        <label>Requester's Area</label>
                                        <input type="text" class="form-control" name="attorney[{{$key}}][area]" 
                                            placeholder="Enter Seller's Area" value="{{$value->owner->area}} Marla" onchange="change(this);">
                                    </div>
                                    
                                    
                                     <input type="hidden" name="requester_id" value="{{$value->owner->id}}">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" readonly value="{{$data->death_date}}" 
                                        placeholder="" >
                                    </div>
                                    <div class="col-md-4">
                                        <label>Death Certificate</label>
                                        <a target="_blank" href="{{asset('uploads/user/death_certificates/'.$data->death_certificate)}}">View Death Certificate</a>
                                    </div>
    ...
    <div class="col-md-4">
        ...
        <input type="text"  class="form-control address" 
            name="receiver[{{$key}}][name]" readonly
            placeholder="Enter Buyer Name" value="{{$value->name}}" onchange="change(this)">
    </div>
    <div class="col-md-4">
        <label>Receiver's Father Name</label>
        <input type="text"  class="form-control address" 
            name="receiver[{{$key}}][father_name]" readonly
            placeholder="Enter Buyer's Father Name" value="{{$value->father_name}}" onchange="change(this)">
    </div>
    <div class="col-md-4">
        <label>Receiver's CNIC</label>
        <input type="text"  class="form-control" 
            id="receiver_cnic_{{$key}}" 
            name="receiver[{{$key}}][cnic]" readonly
            placeholder="Enter Buyer's CNIC" value="{{$value->cnic}}" onchange="change(this)">
    </div>
    ...
    <div class="col-md-4">
        ...
        <input type="text"  class="form-control address" 
            ...
            placeholder="Enter Buyer's Address" onchange="change(this)" value="{{$value->address}}">

    </div>
    <div class="col-md-4">
        <label>Receiver's Area</label>
        <input type="text"  class="form-control" 
            name="receiver[{{$key}}][area]" readonly
            placeholder="Enter Buyer's Area" onchange="change(this)" value="{{$value->area ?? 0}}">

    </div>

    <input type="hidden" name="receiver[{{$key}}][cnic_front]" value="{{$value->cnic_front}}">
    <input type="hidden" name="receiver[{{$key}}][cnic_back]" value="{{$value->cnic_back}}">
    <input type="hidden" name="receiver[{{$key}}][representative]" value="{{$data->representative}}">
    
    <div class="col-md-4">
        <label>Receiver's CNIC</label>
        <p>
            <a href="#"
                class="view-cnic text-primary"
                data-front="/uploads/user/cnics/{{$value->cnic_front}}"
                data-back="/uploads/user/cnics/{{$value->cnic_back}}"
                data-bs-toggle="modal"
                data-bs-target="#cnicModal">
...
<div class="modal fade" id="cnicModal" tabindex="-1" aria-labelledby="cnicModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md modal-dialog-centered">
    <div class="modal-content border-0 shadow rounded-3">
      <div class="modal-header border-bottom-0" style="background:#054468;color:white;">
        <h6 class="modal-title fw-semibold " id="cnicModalLabel">Buyer's CNIC</h6>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body px-3 pb-4 text-center">
        <!-- CNIC Front -->
        <div class="mb-3 flex justify-center flex-col">
          <img id="cnic-front" src="" alt="CNIC Front" class="img-fluid rounded border">
          <div class="small text-muted mt-1">Front Side</div>
        </div>
        <!-- CNIC Back -->
        <div class="flex justify-center flex-col">
          <img id="cnic-back" src="" alt="CNIC Back" class="img-fluid rounded border">
          <div class="small text-muted mt-1">Back Side</div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <input type="text" class="form-control address"  name="witness[{{$key}}][name]"
                                            placeholder="Enter Witness Name" onchange="change(this)" value="{{$value->name}}">
                                    </div>
                                    <div class="col-md-4">
                                        <label>Witness's Father Name</label>
                                        <input type="text" class="form-control address"  name="witness[{{$key}}][father_name]"
                                            placeholder="Enter Witness's Father Name" onchange="change(this)" value="{{$value->father_name}}">
                                    </div>
                                    <div class="col-md-4">
                                        <label>Witness's CNIC</label>
                                        <input type="number" class="form-control"  id="witness_cnic_{{$key}}" name="witness[{{$key}}][cnic]"
                                            placeholder="Enter Witness's CNIC" onchange="change(this)" value="{{$value->cnic}}">
                                    </div>
                                    <div class="col-md-4">
                                        <label>Witness's Address</label>
                                        <input type="text" class="form-control address"  id="first_witness_cnic" name="witness[{{$key}}][address]"
                                            placeholder="Enter Witness's CNIC" onchange="change(this)" value="{{$value->address}}">
                                    </div>
                                     <input type="hidden" name="witness[{{$key}}][cnic_front]" value="{{$value->cnic_front}}">
                                     <input type="hidden" name="witness[{{$key}}][cnic_back]" value="{{$value->cnic_back}}">
                                    <div class="col-md-4">
                                        <label>Witness's CNIC</label>
                                        <p>
                            ...
                            <div class="form-card">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="file-drop-area open-camera"
                                            ...
                                            data-target-input="input-attorney-0"
                                            data-role="receiver"
                                            data-user-id="0"
                                            data-statement="statement-attorney-0"
                                            data-bs-toggle="modal"
                                            data-bs-target="#cameraModal">

                                            <input type="hidden" 
                                                id="input-attorney-0" 
                                                name="receiver[0][picture]"
                                                
                                                >

                                            <span>Click to add or update Picture</span>
                                            <img id="preview-attorney-0" 
                                                class="img-preview"
                                                src="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="file-drop-area pasteButton"
                                            ...
                                            data-target="biometricImg-attorney-0"
                                            data-user="receiver"
                                            data-index="0"
                                            data-thumb = "thumb-attorney-0"
                                            >

                                            <span>Click to add or update Biometric</span>
                                            <img id="biometricImg-attorney-0" 
                                                class="img-preview"
                                                src="">
                                        </div>
                                    </div>
                               ...
                               <div class="row">
                                ...
                                <div class="form-row">
                                    <div class="col-md-4">
                                        <label>Witness Name</label>
                                        <input type="text" disabled class="form-control address" name="buyer_name" readonly
                                            placeholder="Enter Buyer Name" value="{{$value->name}}" onchange="change(this)">
                                    </div>
                                      <div class="col-md-3">
                                    <label for="">Picture</label>
                                     <div class="file-drop-area open-camera" 
                                        ...
                                        data-target-input="input-witness-{{$key}}"
                                        data-role="witness"
                                        data-user-id="{{$key}}"
                                        data-statement="statement_witness_{{$key}}"
                                        data-bs-toggle="modal"
                                        data-bs-target="#cameraModal">
                                         <input type="hidden" id="input-witness-{{$key}}" name="witness[{{$key}}][picture]">
                                        <span>CLick to add or update Picture</span>
                                ...
                                <input type="hidden" id="transfer_file_id" name="request_id" value="{{$request->id}}">
                        ...
                        <fieldset id="third-step">
                            <div class="form-card">
                                <div class="row">
                                    <div class="col-7">
                                        <h2 class="fs-title">Receiver Statements:</h2>
                                    </div>
                                    <div class="col-5">
                                      
                                    </div>
                                </div>
                                  @include('DD.drafts.warassat1',[
                                        'request' => $request,
                                        'property' => $property,
                                        'data' => $data 
                                    ])
                        ...
                        <fieldset id="fourth-step">
                            <div class="form-card">
                                <div class="row">
                                    <div class="col-7">
                                        <h2 class="fs-title">Witness Statements:</h2>
                                    </div>
                                    <div class="col-5">

                                    </div>
                                </div>
                                @include('DD.drafts.warassat2',[
                                        'request' => $request,
                                        'property' => $property,
                                        'data' => $data 
                                    ])
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content border-0 shadow rounded-3">
      ...
      <div class="modal-body text-center">
        <video id="camera" autoplay playsinline width="100%" class="rounded border mb-3"></video>
...
$(document).ready(function(){
    ...
    if (current === 3) {
    takeSnapshot("third-step", "snapshot_step3");
}

// Take snapshot for step 4
if (current === 4) {
    takeSnapshot("fourth-step", "snapshot_step4");
}
    ...
    takeSnapshot('fourth-step', 'snapshot_step4', function () {
