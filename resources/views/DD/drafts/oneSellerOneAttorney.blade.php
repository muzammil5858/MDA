<div class="document-container">
    ...
    بیان بااقرارِ صالح محررہ : {{ \Carbon\Carbon::now()->locale('ur')->translatedFormat('d F Y') }}ء 
                                            ...
                                            <p id="buyer_statement" ><span style="direction: rtl; text-align: right; font-family: 'Noto Nastaliq Urdu', 'Jameel Noori Nastaleeq', serif;"></span>{{$request->participants->first()->representative->name}}:نام</p>
                                            <p id="buyer_statement" ><span style="direction: rtl; text-align: right; font-family: 'Noto Nastaliq Urdu', 'Jameel Noori Nastaleeq', serif;"></span>{{ preg_replace('/\b(ولد|دختر|بیوہ)\b\s*/u', '', $request->participants->first()->father_name) }}
:ولدیت</p>
                                            <p id="seller_statement_address">{{$request->participants->first()->representative->address}}:ساکن</p>
                                            <p id="buyer_statement_cnic">{{$request->participants->first()->representative->cnic}}:شناختی کارڈ نمبر</p>
                                        </div>
                                         <div class="head">
                                             <h1>بیان یا اقرار صالح محررہ</h1>
                                            <p id="buyer_statement" ><span style="direction: rtl; text-align: right; font-family: 'Noto Nastaliq Urdu', 'Jameel Noori Nastaleeq', serif;"></span>{{$request->participants->first()->owner->name}}:نام</p>
                                            <p id="buyer_statement" ><span style="direction: rtl; text-align: right; font-family: 'Noto Nastaliq Urdu', 'Jameel Noori Nastaleeq', serif;"></span>{{ preg_replace('/\b(ولد|دختر|بیوہ)\b\s*/u', '', $request->participants->first()->father_name) }}
:ولدیت</p>
                                            <p id="seller_statement_address">{{$request->participants->first()->owner->address}}:ساکن</p>
                                            <p id="buyer_statement_cnic">{{$request->participants->first()->owner->cnic}}:شناختی کارڈ نمبر</p>
                                        </div>
                                    </div>
                                    @php
                                            $value = '';
                                            if($property->marla == null || $property->marla == 0){
                                                $value = $property->kanal.'کینال';
                                            }
                                            else{
                                                $value = $property->marla.'مرلہ';
                                            }
                                        @endphp
                                    <div class="content">
                                    ...
                                    <div class="signature">
                                        ...
                                        <div class="fingerprint">
                                             <img src="" id="thumb-witness-1" style="margin-right:auto;margin-left:auto" alt="Fingerprint">
                                            <p> دستخط / نشان انگوٹها گواه شناخت نمبر (
                                                2) </p>
                                        </div>
                                        <div class="fingerprint">
                                             <img src="" id="thumb-witness-0" style="margin-right:auto;margin-left:auto" alt="Fingerprint">
