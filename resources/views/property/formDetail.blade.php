    ...
    <div class="py-12">
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-6">
                                ...
                                <fieldset id="first-step">
                                    <div class="form-card">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="detail-item col-md-4  ">
                                                <label for="name">Allotment Type</label>
                                                <p id="phone">{{$property->allotment_type}}</p>
                                              
                                            </div>
                                            <div class="detail-item col-md-4  ">
                                                <label for="name">Transfer Count</label>
                                                <p id="phone">{{$property->transfer_count}}</p>
            ...
            <div class="detail-item col-md-4">
                ...
                <p>{{ $value->father_name }}</p>
            </div>
            <div class="detail-item col-md-3">
                <label>CNIC</label>
                <p>{{ $value->cnic }}</p>
            </div>
            {{-- Optional Area Field (empty) --}}
            <div class="detail-item col-md-1">
                <label>Area</label>
                <p>{{ $value->area }}</p>
            </div>
        </div>
        @endforeach
                                    ...
                                    {{-- < class="form-card"> --}}
                                        ...
                                        <form method="POST" id="msform" action="{{ route('QAstore') }}">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" name="remarks" value="{{ $property->remarks }}"
                                        ...
                                        <div class="row">
                                                    ...
                                                    @if(auth()->user()->hasRole('director'))
                                                    <a href="/old-property-tranasfer/{{$property->id}}" style="width:100% !important;" ><button class="btn btn-primary form-control mb-3" style="width:100% !important;;">Transfer</button></a>
                                                    @endif
                                                </div>
