    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                ...
                <form action="/transfer-file-update/{{$property->id}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-row mt-2">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="town" class="form-control" id="town" disabled>
                                ...
                                <option {{$property->town == '3' ? 'selected' : '' }} value="4">New Small Town Chaksawari</option>
                    ...
                    <div class="form-row mt-2">
                        <div class="col">
                            <p id="declare">
                                I, <span id="declarer-name">{{$property->allotee_name}}</span>, SO/DO <span id="declarer-fname">{{$exist->declarer_fname}}</span>, hereby declare that I am the lawful owner of <span>Plot No </span><span id="plot-no">{{$property->plot_no}}</span>, situated at <span id="town-name">@php
                                    $town = DB::table('towns')->where('id',$property->town)->first();
                                    echo $town->name;
                                @endphp</span><span id="sector1">,Sector {{$property->sector}}</span>, and I willingly transfer the said plot to <span id="transferee-name">{{$exist->transferee_name}}</span>, son of <span id="transferee-fname">{{$exist->transferee_fname}}</span>, without any pressure, coercion, or undue influence.
                    ...
                    <div class="form-row">
                       <input type="hidden" name="alotment_order" value="{{$exist->alotment_order}}">
                       <input type="hidden" name="cnic_back" value="{{$exist->cnic_front}}">
                       <input type="hidden" name="cnic_front" value="{{$exist->cnic_back}}">
                        ...
                        <div class="col-md-4">
                            ...
                            value="" />
                            @if($exist->cnic_front)
                            <a target="_blank" href="{{asset('/uploads/user/cnic/'.$exist->cnic_front)}}">View Front CNIC Attachement</a>
                            @endif
                            <div class="invalid-feedback" id="error-paddress"></div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            value="" />
                            @if($exist->cnic_back)
                            <a target="_blank" href="{{asset('/uploads/user/cnic/'.$exist->cnic_back)}}">View Back CNIC Attachement</a>
                            @endif
                            <div class="invalid-feedback" id="error-paddress"></div>
                        </div>
                    </div>
