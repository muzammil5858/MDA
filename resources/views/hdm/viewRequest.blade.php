    ...
    <div id="statusSection" class="form-row px-4"
        ...
        <div class="col-md-3">
            ...
            <select name="verify_status" id="verify_status" class="form-control">
                ...
                <option {{ $request->head_status == 'accept' ? 'selected' : '' }} value="accept">Approved</option>
                <option {{ $request->head_remarks == 'reject' ? 'selected' : '' }} value="reject">Disapproved</option>
            </select>
        </div>
        <div class="col-md-6">
            <label for="remarks">Remarks</label>
            <textarea name="remarks" class="form-control"
                placeholder="Enter Remarks">{{ $request->head_remarks }}</textarea>
        </div>
        <div class="col-md-3">
            <label for="date">Date</label>
            <input type="date" name="date" value="{{ $request->head_date }}" class="form-control">
        </div>
    </div>
