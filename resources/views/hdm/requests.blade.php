                                    ...
                                    <tbody>
                                        @foreach($pendingApplications as $application)
                                            <tr>
                                                ...
                                                <td>
                                                    @if($application->engineer_status == 1)
                                                    <span class="badge badge-success">Accepted Sub-engineer</span>
                                                    @elseif($application->engineer_status == 0)
                                                    <span class="badge badge-danger">Rejected Sub-engineer</span>
                                                    @elseif($application->engineer_status == 2)
                                                ...
                                                <td>
                                                    <a href="/hdm/view-pending-request/{{ $application->id }}" class="btn btn-sm btn-info" title="View Details">
