                                    ...
                                    <div class="form-card">
                                            ...
                                            <div class=" col-md-8">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <input type="number" id="dm_acre" placeholder="acre" name="dm_acre" class="form-control"
                                                        value="{{  $property->dm_acre ?? ''}}">
                                                    </div>
                                                    <div class="col">
                                                        <label for="name">Kanal</label>
                                                        <input type="number" id="dm_kanal" placeholder="kanal" name="dm_kanal" class="form-control"
                                                        value="{{  $property->dm_kanal ?? ''}}">
                                                    </div>
                                                    <div class="col">
                                                        <label for="name">Marla</label>
                                                        <input type="number" id="dm_marla" placeholder="marla" name="dm_marla" class="form-control"
                                                        value="{{  $property->dm_marla ?? ''}}">
                                                    </div>
                                                    <div class="col">
                                                        <label for="name">Squarefeet</label>
                                                        <input type="number" id="dm_sqrft" placeholder="sqrft" name="dm_sqrft" class="form-control"
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class=" col-md-8">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <label for="name">Acre</label>
                                                        <input type="number" id="acre" placeholder="acre" name="acre" class="form-control"
                                                        value="{{  $property->acre ?? ''}}">
                                                    </div>
                                                    <div class="col">
                                                        <label for="name">Kanal</label>
                                                        <input type="number" id="kanal" placeholder="kanal" name="kanal" class="form-control"
                                                        value="{{  $property->kanal ?? ''}}">
                                                    </div>
                                                    <div class="col">
                                                        <label for="name">Marla</label>
                                                        <input type="number" id="marla" placeholder="marla" name="marla" class="form-control"
                                                        value="{{  $property->marla ?? ''}}">
                                                    </div>
                                                    <div class="col">
                                                        <label for="name">Squarefeet</label>
                                                        <input type="number" id="sqrft" placeholder="sqrft" name="sqrft" class="form-control"
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class=" col-md-4 " id="bps">
                                                ...
                                                <input type="number" class="form-control" name="cnic" value="{{  $property->cnic ?? ''}}">
